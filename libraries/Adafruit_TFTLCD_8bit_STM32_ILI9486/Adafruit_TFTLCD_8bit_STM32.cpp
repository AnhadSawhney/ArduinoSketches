...
void Adafruit_TFTLCD_8bit_STM32::setAddrWindow(int16_t x1, int16_t y1, int16_t x2, int16_t y2)
{
	...
	} else if (driver == ID_9486){
		ili9486_setAddrWindow(x1, y1, x2, y2);
	}
}
...
void Adafruit_TFTLCD_8bit_STM32::flood(uint16_t color, uint32_t len)
{
  ...
  } else if (driver == ID_ILI9486) {
	writeCommand(ILI9486_MEMORYWRITE); //16 bit
...
void Adafruit_TFTLCD_8bit_STM32::fillScreen(uint16_t color)
{
  ...
  } else if ((driver == ID_9341) || (driver == ID_9486) || (driver == ID_7575) || (driver == ID_HX8357D) || (driver == ID_9338)) {
...
void Adafruit_TFTLCD_8bit_STM32::drawPixel(int16_t x, int16_t y, uint16_t color)
{
  ...
  } else if ((driver == ID_9341) || (driver == ID_9486) || (driver == ID_HX8357D) || (driver == ID_9338)) {
...
void Adafruit_TFTLCD_8bit_STM32::pushColors(uint16_t *data, int16_t len, boolean first)
{
  ...
  if(first == true) { // Issue GRAM write command only on first call
    ...
    if ((driver == ID_9341) || (driver == ID_9486) || (driver == ID_HX8357D) || (driver == ID_9338)){
       write8(0x2C);
     }  else {
       write8(0x22);
     }
...
void Adafruit_TFTLCD_8bit_STM32::setRotation(uint8_t x)
{
  ...
  if (driver == ID_932X) {
   ...
   // MEME, ID_9486 uses same registers as 9341
   uint16_t t;
...
/**/
  ...
  if (id != 0x9341 && id != 0x9338 && id != 0x9486) {
    id = readReg(0);
  }
