...
const uint8_t ILI9486_regValues_ada[] = {        // Adafruit_TFTLCD only works with EXTC=0
...
*/
const uint8_t ILI9486_regValues_post[] =
...
//	Serial.println("\nILI9486 begin...");
	...
	//init_table(ILI9486_regValues_ada, sizeof(ILI9486_regValues_ada));   //can change PIXFMT
	init_table(wake_on, sizeof(wake_on));
	//init_table(ILI9486_regValues_post, sizeof(ILI9486_regValues_post));
}
...
/*****************************************************************************/
void ili9486_setAddrWindow(int16_t x1, int16_t y1, int16_t x2, int16_t y2)
{
...
/*****************************************************************************/
void ili9486_setRotation(uint8_t x)
{
}

/*****************************************************************************/
uint16_t ili9486_readPixel(int16_t x, int16_t y)
{
	return 0;
}
